...
<ul>
   ...
   <li><a href='assets/freq_q_ans.html'>FAQ's</a></li>
   <li><a href='assets/privacy_policies.html'>Privacy Policies</a></li>
   <h2 style="float: right; margin-top: 10px; font-family: Verdana;">ConfessionWeb</h2>
</ul>
</div>
		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form action="login.php" method="post" class="login100-form validate-form">
					<span class="login100-form-title p-b-33">Sign in
					</span>
...
<br>
						...
						<span class="txt1">
							By continuing, I agree that I am at least 13 years old and have read and agree to the terms of service and <a href="assets/privacy_policies.html">privacy policy</a>.
						</span>
